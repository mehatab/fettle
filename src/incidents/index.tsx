                                    ...
                                    <div className='ml-6 border-l-4'>
                                        {
                                            (incidents.incidents as Incidents[]).map(incident => (
                                                <div className='flex' key={incident.id}>
                                                    <div className='-ml-4 mt-5 flex rounded-full w-7 h-7 bg-gray-300'>
                                                    ...
                                                    <div className='items-center ml-3 mt-5'>
                                                        ...
                                                        <p className='text-sm text-gray-500'>{incident.created_at} -{incident.closed_at}</p>
                                                    </div>
                                                </div>
                                            ))
                                        }
